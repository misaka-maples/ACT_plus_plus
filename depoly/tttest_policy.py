...
import numpy as np
import torch
# from rem_test import QposRecorder
...
if __name__ == '__main__':
    ...
    camera_top_data, camera_right_data, qpos_list = get_state('/home/zhnh/Documents/xzx_projects/aloha_deploy/act-plus-plus/episode_7.hdf5')
    actions_list=[]
    for i in range(len(camera_right_data)):
        ...
        print(actions)
        # actions = [i*180/3.141592653589793 for i in actions]
        actions_list.append(actions)
        # print(actions_list)
        # for i in range(2000):
        #     for j in range(6):
        #         QposRecorder.joint_state_right[j] = actions[j]
        #     power = actions[6]
        #     if power > 2:
