...
To generated 50 episodes of scripted data, run:
    ...
    python record_sim_episodes.py --task_name sim_transfer_cube_scripted --dataset_dir ./results --num_episodes 1

To can add the flag ``--onscreen_render`` to see real-time rendering.
To visualize the simulated episodes after it is collected, run

    python visualize_episodes.py --dataset_dir ./mirror_tran --episode_idx 11
...
To train ACT:
    ...
    # Transfer Cube task
    python imitate_episodes.py --task_name sim_transfer_cube_scripted --ckpt_dir ./results --policy_class ACT --kl_weight 10 --chunk_size 100 --hidden_dim 512 --batch_size 8 --dim_feedforward 3200 --num_steps 2000  --lr 1e-5 --seed 0
