...
class ActionGenerator:
    def __init__(self, args):
        ...
        self.config_data['temporal_agg'] = args['temporal_agg']
        # print(self.config_data)

        # 设置配置
        # self.policy_config = {
        #     # 'lr': args['lr'],
        #     'num_queries': self.config_data['chunk_size'],
        #     'chunk_size':self.config_data['chunk_size'],
        #     'backbone': self.config_data['backbone'],
        #     'enc_layers': 4,
        #     'dec_layers': 7,
        #     'nheads': self.config_data['num_heads'],
        #     'camera_names': self.config_data['camera_names'],
        #     # 'vq': args['use_vq'],
        #     'kl_weight': self.config_data['kl_weight'],
        #     'action_dim': self.config_data['action_dim'],
        #     # 'no_encoder': args['no_encoder'],
        #     'state_dim': self.config_data['state_dim'],
        #     "eval": True,
        #     'policy_class': self.config_data['policy_class'],
        #     'temporal_agg': self.config_data['temporal_agg'],
        #     'vq':self.config_data['vq'],
        # }
        ...
        self.temporal_agg = self.config_data['temporal_agg']
        self.num_queries = self.config_data['chunk_size']
        self.max_timesteps = args['max_timesteps']
        self.t = None
        self.all_time_actions = None
        self.query_frequency = self.config_data['chunk_size']
    ...
    def _get_image(self, ts, image_dict):
        ...
        """
        curr_images = []
        for cam_name in self.config_data['camera_names']:
            # 获取并调整图像维度
    ...
    def _eval_bc_with_external_inputs(self, qpos, image_dict):
        ...
        if self.temporal_agg:
            self.all_time_actions = torch.zeros([self.max_timesteps, self.max_timesteps + self.num_queries, self.config_data['action_dim']]).cuda()
