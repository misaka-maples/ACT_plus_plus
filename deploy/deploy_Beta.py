...
from hdf5_edit_utils import get_image_from_folder, get_top_right_image
...
def main(args):
    camera_top_data, camera_right_data, qpos_list, action_ = get_state(
        r'/workspace/ACT_plus_plus/test/episode_1.hdf5')
    # actions_list = []
    # qpos_list = []
    ...
    visualize_joints(qpos_list, actions_list, image_path, STATE_NAMES=STATE_NAMES)
