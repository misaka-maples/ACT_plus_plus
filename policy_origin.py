...
import torch
import numpy as np
from detr_origin.main import build_ACT_model_and_optimizer, build_CNNMLP_model_and_optimizer
import IPython
e = IPython.embed
...
class ACTPolicy(nn.Module):
    ...
    def __call__(self, qpos, image, actions=None, is_pad=None, vq_sample=None):
        ...
        if actions is not None:  # 训练模式
            ...
            alpha = 0.5
            loss_dict['loss'] = alpha * loss_dict['l1'] + loss_dict['kl'] * self.kl_weight 
            return loss_dict
        else:  # 推理模式
